...
This guide covers how to charge the vehicle battery using the iMAX B6AC V2 charger. The charger is already configured for the correct battery type and capacity — you just need to connect the battery and start charging.
...
1. Press and hold **Start/Enter** to begin charging. The charger beeps to confirm.
