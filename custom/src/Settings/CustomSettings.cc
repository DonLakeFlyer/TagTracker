...
DECLARE_SETTINGSFACT(CustomSettings, antennaModel)
...
DECLARE_SETTINGSFACT(CustomSettings, controllerVerboseLogging)
DECLARE_SETTINGSFACT(CustomSettings, pythonK)
DECLARE_SETTINGSFACT(CustomSettings, pythonFalseAlarmMode)
