...
SliceSequenceCaptureState::SliceSequenceCaptureState(QState* parentState, int firstSlice, int skipCount, bool clockwiseDirection, int sliceCount)
    : CustomState       ("SliceSequenceCaptureState", parentState)
